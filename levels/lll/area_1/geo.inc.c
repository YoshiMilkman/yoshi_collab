...
const GeoLayout lll_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, lll_dl_Castle_mesh_layer_5),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, lll_dl_grass_top_decal_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Mud_Vis_mesh_layer_1),

...
const GeoLayout lll_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, lll_dl_Castle_001_mesh_layer_5),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, lll_dl_grass_top_decal_mesh_layer_7),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Hangable_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, lll_dl_Mud_Vis_mesh_layer_7),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, lll_dl_Mud_Vis_001_mesh_layer_7),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_pole_vis_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE_INTER, lll_dl_skybox_mesh_layer_3),

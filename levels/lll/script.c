...
const LevelScript level_lll_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_COOL_CHERRY_TREE, cool_cherry_tree_geo), 
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_COOL_CHERRY_TREE, -3419, 1546, 1466, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, -3419, 1546, -534, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, -3419, 1546, 3466, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, -2619, 1546, -1884, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, 3419, 1546, 3466, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, 3419, 1546, 1466, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, 3419, 1546, -534, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, 2619, 1546, -1884, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_KOOPATROL, -406, 0, 853, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, -2643, 0, 3132, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 2384, 0, 2740, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, -171, 0, 3095, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 1451, 0, -18, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, -2110, 0, -709, 0, 0, 0, 0x00000000, bhvKoopatrol),

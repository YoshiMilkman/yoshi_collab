...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_COOL_CHERRY_TREE, 3419, 1546, -534, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_COOL_CHERRY_TREE, 2619, 1546, -1884, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_KOOPATROL, 0, 0, 722, 0, 0, 0, 0x00000000, bhvKoopatrol),
		...
		OBJECT(MODEL_NONE, -426, 715, 8294, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -426, 715, 8294),
